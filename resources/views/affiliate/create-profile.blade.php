    ...
    <div class="view another-view">
        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="center sliding">Create Affiliate Profile</div>
                <div class="right">
        ...
        <div class="pages navbar-fixed toolbar-fixed ">
            <div class="page" data-page="settings">
                <div class="page-content">
                    <!-- Form to submit affiliate profile information including image upload-->
                                ...
                                <li class="mt-10">
                                    <div class="item-content">
                                        ...
                                        <div class="item-inner">
                                            ...
                                            <img src="{{url("avatars/default2.jpg")}}" id="avatar-preview" height="75px" width="75px" alt="image"/>
                                        </div>
                                    </div>
                                </li>
                            </ul>
